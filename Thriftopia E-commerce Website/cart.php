...
<body>
    <div class="spotlight-header-container">
        <span class="spotlight-header">🛒 WHAT'S THE DAMAGAE? 🛒</span>
    </div>
    <br>
    ...
    if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
        ...
        foreach ($_SESSION['cart'] as $product_id => $quantity) {
            ...
            if ($result->num_rows > 0) {
                ...
                $total_price += $total;
                echo "<div><img src='" . $row["Image"] . "' alt='product-img' class ='cart-img'></div><div style='margin-left: 5px; margin-top: 5px'><h1>" . $product_name . "</h1><h3> Quantity: <b>" . $quantity . "</b> </h3><h4> R" . $price . "</h4><p> TOTAL: R" . $total . "</p><br></div>";
            }
            echo "</div>";
            echo "<br>";
        }
        ...
        echo "</div>";
        echo "<div class='Absolute-Center'>";        
        $shippingcost = ($total_price * 0.3);
        echo " <h2 class = 'shipping'> SHIPPING COST: R" . $shippingcost  . "</h2>";             
        echo "</div>";        
        echo "<div class='Absolute-Center'>";        
        echo "<h2 class='grandtotal'> GRAND TOTAL: R" . $total_price + $shippingcost  . "</h2> ";
        echo "</div>";
        echo "<div class='spotlight-header-container'>";
        echo "<span class='spotlight-header'>";
        echo "<button onclick='history.back()' class='btn'>⬅️Continue Shopping</button>";
        ...
        <div id="footer" style="background-color: white; opacity: 0.7;">
            <div class="all-grid">
                ...
                <div class="footer-col-3">
                    ...
                    <div style="display: grid; grid-template-rows: 1fr 1fr; grid-template-columns: 1fr 1fr 1fr; grid-gap: 5px;width: 200px;margin: 0 auto;">
                        <div>
