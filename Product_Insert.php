<?php
//GONNA BE CHANGED SO THAT THE ADMIN CAN ADD NEW CLOTHING ITEMS!
//BUT FOR NOW IT'S ONLY GOING TO BE MANUAL
include("dbcon.php");
$sql = "INSERT IGNORE INTO product( Product_ID, Name, Description, Price, Image ) 
            VALUES 
            (01,
            'Gucci Black Dress',
